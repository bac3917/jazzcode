# various resources:
# for accessing user data: https://colinfay.me/data-vinyles-discogs-r/ 
# Construct API request: # https://www.discogs.com/developers/#page:database,header:database-artist-releases-get
...
library(jsonlite) library(DT);library(magrittr);library(plotly)
...
# how to make database of all personnel on a given album?
